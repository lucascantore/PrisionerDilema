...
class DaleCooper(Prisoner):
    ...
    def change_strategy(self):
        ...
        if (vecesDisentidas == 0):
            ...
            if (MaxDisentirConsecutivos > 2 or (cadenasCooperacionAisladas > 1 and
                                                cadenaCooperacionPromedio < 3) or (cadenasCooperacionAisladas > 2 and
                                                                                   cadenaCooperacionPromedio < 2)):
